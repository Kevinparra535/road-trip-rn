export const TYPES = {
  ...
  NavPreferencesRepository: Symbol.for('NavPreferencesRepository'),
  RouteDraftRepository: Symbol.for('RouteDraftRepository'),
  ElevationRepository: Symbol.for('ElevationRepository'),
  OfflineMapRepository: Symbol.for('OfflineMapRepository'),
  ...
  DownloadOfflineCorridorUseCase: Symbol.for('DownloadOfflineCorridorUseCase'),
  ...
  SuggestPlacesUseCase: Symbol.for('SuggestPlacesUseCase'),
  RetrievePlaceUseCase: Symbol.for('RetrievePlaceUseCase'),
  ReverseGeocodeUseCase: Symbol.for('ReverseGeocodeUseCase'),
  ...
  GetNavPreferencesUseCase: Symbol.for('GetNavPreferencesUseCase'),
  SetMutePreferenceUseCase: Symbol.for('SetMutePreferenceUseCase'),
